...
public void upPage(GImageButton source, GEvent event) { //_CODE_:pause_button:527890:
  pageNumber = constrain(pageNumber - 1, 1, numPages);
} 

public void downPage(GImageButton source, GEvent event) { //_CODE_:pause_button:527890:
  pageNumber = constrain(pageNumber + 1, 1, numPages);
} 
...
public void createGUI(){
  ...
  upPage = new GImageButton(this, 500, 400, 35, 35, new String[] { "Up Page.png", "Up Page.png", "Up Page.png" } );
  upPage.addEventHandler(this, "upPage");
  downPage = new GImageButton(this, 600, 400, 35, 35, new String[] { "Down Page.png", "Down Page.png", "Down Page.png" } );
  downPage.addEventHandler(this, "downPage");
